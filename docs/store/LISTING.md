...
| Asset | Spez | Quelle |
|---|---|---|
| App-Icon | 512×512 PNG, ≤1 MB | Export aus `app/assets/images/icon.png`-Pipeline (`tools/gen_tokens.py`-Palette) |
...
| Phone-Screenshots | 1080×2400 PNG, min. 2, max. 8 | ✅ `docs/store/screenshots/01-board.png` … `04-uebersicht.png` (auf Emulator gegen Demo-Daemon aufgenommen, keine echten Kundendaten) |
