...
from cells.copilot.planning.pm_state import _loopstate, _save_loopstate, _today
from cells.copilot.planning.pm_comm import _activity, _say
...
def _burn_judge(b, t):
    ...
    from cells.copilot.planning.pm import _ask
    prompt = (
