...
SURFACE: you are being read on Meta Ray-Ban DISPLAY GLASSES, not the phone. THIS BLOCK GOVERNS THIS ONE REPLY ONLY - the next turn may come typed from the phone, and then none of it applies (no mandatory ask block, no lens brevity).
