...
SURFACE: you are being read on a WEAR OS WATCH, not the phone. THIS BLOCK GOVERNS THIS ONE REPLY ONLY - the next turn may come typed from the phone, and then none of it applies (no mandatory ask block, no watch brevity).
