...
export const screens: Dict = {
  ...
  "updates.diag.section": { de: "Update-Diagnose", en: "update diagnostics" },
  "updates.diag.updateId": { de: "Update-ID", en: "Update ID" },
  "updates.diag.createdAt": { de: "Erstellt", en: "Created" },
  "updates.diag.emergency": { de: "Notfall-Start", en: "Emergency launch" },
  "updates.diag.native": { de: "Native Fehler", en: "Native errors" },
  "updates.diag.log": { de: "expo-updates Log (letzte 50)", en: "expo-updates log (last 50)" },
  "updates.diag.logEmpty": { de: "Keine Log-Einträge.", en: "No log entries." },
  "updates.diag.logReload": { de: "Neu laden", en: "Reload" },
  "updates.diag.copy": { de: "Alles kopieren", en: "Copy all" },
  "updates.diag.copied": { de: "Kopiert", en: "Copied" },
  "updates.silentNote": {
