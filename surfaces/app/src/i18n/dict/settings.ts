...
export const settings: Dict = {
  ...
  "takeout.hint": { de: "Packt alles in ein Archiv: Gedächtnis, Karten, Chat, Konten, Einstellungen. Schlüssel bleiben ausdrücklich hier.", en: "Packs everything into one container: memory, cards, chat, accounts, settings. Keys deliberately stay here." },
  "takeout.start": { de: "Archiv erstellen", en: "Create archive" },
  "takeout.running": { de: "Läuft …", en: "Running …" },
  "takeout.verify": { de: "Letztes Archiv prüfen", en: "Verify latest archive" },
  ...
  "takeout.incomplete": { de: "Unvollständig. Der Lauf wurde abgebrochen, erstell ein neues.", en: "Incomplete. The run was interrupted, create a new one." },
  ...
  "takeout.verifyOkTitle": { de: "Archiv vollständig", en: "Archive complete" },
  "takeout.verifyOkBody": { de: "Prüfsummen stimmen, der Vollständigkeitsmarker ist gesetzt.", en: "Checksums match and the completeness marker is set." },
  "takeout.verifyBadTitle": { de: "Archiv beschädigt", en: "Archive damaged" },
