...
export const settings: Dict = {
  ...
  "restore.freshTitle": { de: "Neu einrichten", en: "Set up fresh" },
  "restore.freshSub": { de: "Dieser Rechner fängt bei null an. Vorhandene Notizen aus Claude Code oder Cursor kannst du gleich danach übernehmen.", en: "This machine starts from scratch. You can pull in existing notes from Claude Code or Cursor right afterwards." },
  "restore.freshBtn": { de: "Neu einrichten", en: "Set up fresh" },
  "restore.takeTitle": { de: "Von einem anderen Rechner übernehmen", en: "Take over from another machine" },
  "restore.takeSub": { de: "Du hast dort ein Archiv erstellt. Spiel es hier ein, bevor du ein Konto anlegst: das Archiv bringt dein Konto mit.", en: "You made an archive there. Restore it before creating an account: the archive brings your account with it." },
  "restore.takeBtn": { de: "Archiv einspielen", en: "Restore archive" },
  "restore.pathHint": { de: "Pfad zum Archivordner auf diesem Rechner. Den ganzen Ordner, nicht eine Datei daraus.", en: "Path to the archive folder on this machine. The whole folder, not a file inside it." },
  "restore.checkBtn": { de: "Archiv prüfen", en: "Check archive" },
  "restore.previewOk": { de: "Vollständig: {notes} Notizen, {cards} Karten, {users} Konten. Nichts ist bisher passiert.", en: "Complete: {notes} notes, {cards} cards, {users} accounts. Nothing has happened yet." },
  "restore.goBtn": { de: "Jetzt einspielen", en: "Restore now" },
  "restore.back": { de: "Zurück", en: "Back" },
  "mimport.title": { de: "Gedächtnis übernehmen", en: "Bring your memory" },
  "mimport.hint": { de: "Wenn du schon mit Claude Code, Cursor oder Codex gearbeitet hast, holt HelmDeck deine Notizen und Regeln herüber. Nichts wird überschrieben.", en: "If you already worked with Claude Code, Cursor or Codex, HelmDeck pulls your notes and rules across. Nothing is overwritten." },
  "mimport.take": { de: "Übernehmen", en: "Bring it over" },
  "mimport.running": { de: "Läuft …", en: "Running …" },
  "mimport.count": { de: "{n} Einträge", en: "{n} entries" },
  "mimport.imported": { de: "{n} übernommen", en: "{n} imported" },
  "mimport.noneFound": { de: "Kein vorhandenes Gedächtnis gefunden. Du fängst frisch an, das ist völlig in Ordnung.", en: "No existing memory found. You start fresh, which is perfectly fine." },
  "mimport.scan": { de: "Zusätzlich mit Claude suchen", en: "Also search with Claude" },
  "mimport.scanRunning": { de: "Claude sucht …", en: "Claude is looking …" },
  "mimport.scanWait": { de: "Dauert etwa eine halbe Minute. Claude sieht sich die Konfigurationsordner an und sagt, welche zu einem Coding-Assistenten gehören.", en: "Takes about half a minute. Claude looks at the config folders and says which belong to a coding assistant." },
  "mimport.scanFound": { de: "{n} zusätzlich gefunden", en: "{n} more found" },
  "mimport.scanNothing": { de: "Nichts Zusätzliches gefunden. Die bekannten Orte oben decken diesen Rechner ab.", en: "Nothing more found. The known locations above cover this machine." },
  "mimport.absent": { de: "Gesucht, nicht gefunden", en: "Looked for, not found" },
  "mimport.doneTitle": { de: "Übernommen", en: "Imported" },
  "mimport.doneBody": { de: "{n} übernommen, {skipped} übersprungen, weil es den Namen hier schon gibt. Vorhandene Notizen bleiben unberührt.", en: "{n} imported, {skipped} skipped because the name already exists here. Existing notes are untouched." },
  "mimport.failedTitle": { de: "Übernahme fehlgeschlagen", en: "Import failed" },
  ...
  "takeout.cNotes": { de: "{n} Notizen", en: "{n} notes" },
  "takeout.cCards": { de: "{n} Karten", en: "{n} cards" },
  "takeout.cChat": { de: "{n} Chat-Zeilen", en: "{n} chat rows" },
  "takeout.cUsers": { de: "{n} Konten", en: "{n} accounts" },
  "takeout.cRecordings": { de: "{n} Aufnahmen", en: "{n} recordings" },
