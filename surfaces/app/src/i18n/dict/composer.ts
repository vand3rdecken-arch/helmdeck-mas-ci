...
export const composer: Dict = {
  ...
  "chat.threads.active": { de: "Aktiv", en: "Active" },
  "chat.threads.folders": { de: "Ordner", en: "Folders" },
  "chat.threads.recent": { de: "Zuletzt", en: "Recent" },
  "chat.threads.more": { de: "{n} weitere anzeigen", en: "Show {n} more" },
  "chat.threads.doneFolders": { de: "Abgeschlossene Ordner ({n})", en: "Finished folders ({n})" },
  "chat.threads.running": { de: "läuft", en: "running" },
  "chat.threads.review": { de: "Abnahme", en: "review" },
  "chat.threads.needsYou": { de: "wartet auf dich", en: "waiting for you" },
