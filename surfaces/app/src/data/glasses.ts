 ...
 *  compiled and present in the APK, and DEAD: nothing in surfaces/app/src could start an
 *  Android Service, and nothing wrote the daemon target they read from
 *  SharedPreferences. ops/docs/glasses-reference.md §11.6 recorded that for the
 ...
 *  surfaces/glasses/worker that already proxies exactly /glance, /glance/answer,
