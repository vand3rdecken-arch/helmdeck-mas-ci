 ...
 *    phone and WhatsApp (ops/docs/voice-interaction-design.md SS3).
 ...
 *    EXACTLY to the version that was compiled (see surfaces/app/package.json).
...
export interface VoiceCaps {
   ...
   *  `ops/tools/probe_duplex.js` to re-check; the day it comes back true, THAT is
 ...
 *  audio it is listening past - see ops/docs/voice-interaction-design.md SS4.5. */
