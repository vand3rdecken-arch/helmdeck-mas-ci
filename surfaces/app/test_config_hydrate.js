...
//
// Background: surfaces/desktop/main.js used to mint an owner device token at every
...
//
// Run: node surfaces/app/test_config_hydrate.js     (from the repo root or app/)
...
// The hash surfaces/desktop/main.js actually builds now - read from the file so this
...
function realDesktopHashFields() {
  ...
  if (!block) throw new Error("could not find the cfg block in surfaces/desktop/main.js");
  return block[1];
}
...
async function main() {
  console.log("surfaces/desktop/main.js must not hand the SPA a token");
