...
//   - Android has a hand-managed surfaces/app/android, so it needs TWO paths kept in
...
//   1. It only runs on the `expo prebuild` path. HelmDeck's surfaces/app/android is
...
// rule as the manifest: surfaces/app/android is hand-managed and regenerates from
...
// Bluetooth radio at the same time (ops/docs/glasses-reference.md 12.4 - a measured
