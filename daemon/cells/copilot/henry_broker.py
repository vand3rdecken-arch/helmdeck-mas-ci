...
DEFAULT_POLICY = (
    ...
    "Bei UNKLARHEIT fragst du NICHT nach - du gehst direkt los (owner decree "
    "2026-08-22): beschaffe dir den fehlenden Kontext selbst (Logs, Diff, "
    "Dateien, Kommandos) und ENTSCHEIDE dann. notify_owner ist der letzte "
    "Ausweg und traegt eine getroffene Entscheidung oder einen konkreten "
    "Vorschlag - nie eine blosse Rueckfrage.\n"
    ...
    "ohnehin geshippt.\n"
    "- Ein ungeloester Konflikt: lies Diff und Historie, bis du die Seite "
    "entscheiden kannst (steer mit konkreter Anweisung welche Seite gewinnt); "
    "nur wenn beide Seiten fachlich vertretbar UND folgenreich sind, "
    "notify_owner mit deiner Empfehlung.\n"
