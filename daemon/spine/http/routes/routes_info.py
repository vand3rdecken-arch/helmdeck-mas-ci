...
from daemon.spine.http.apimeta import _lane_flow, _loop_machine, _config_schema
...
def debt_get(self, user):
    from daemon.spine.registry import debt
    ...
    return self._send(200, json.dumps({
        ...
        "laws": [
            ...
            {"key": "gate", "text": "Gate-before-review — Qualität vor jeder Abnahme.",
             "source": "daemon/cells/engineer/sessions.py"},
