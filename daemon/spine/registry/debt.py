...
DEBT = [
    ...
    },
    {
        ...
        "why_it_bites": "⚠ UPDATED 2026-08-21 - point (1) is now PAID and the "
                        ...
                        "(3) STILL OPEN: nothing in app/src starts either "
                        "service - the JS->native seam is absent, so both remain "
                        "unreachable from the UI exactly as GlassVoiceService "
                        "already was. So the code is PROVEN TO BUILD and is NOT "
                        "yet proven to work; nothing here has run on glasses.",
