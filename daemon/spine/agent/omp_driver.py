...
from daemon.spine.agent.proctable import _tree_kill, _record_pid, _forget_pid
from daemon.spine.agent.claude_transcript_fmt import _clean_text
...
def _oauth_token():
    ...
    from daemon.spine.agent.turnopts import _oauth_token as _tok
    return _tok()
