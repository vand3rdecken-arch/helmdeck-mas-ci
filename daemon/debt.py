...
DEBT = [
    ...
    },
    {
        ...
        "what": "The full-dynamism decree made the APP a plugin composition, but "
                ...
                "SEAMS DONE (7, all FULL-suite 11/11 verified): from sessions.py "
                ...
                "1136->1051. All via lazy back-imports where a moved fn needs a "
                "sessions helper (no cycle). REMAINING: server.py (2109, split "
