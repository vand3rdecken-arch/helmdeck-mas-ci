...
DEBT = [
    ...
    },
    {
        ...
        "what": "Owner decree: the unit of modularity is an agentic SYSTEM (a "
                ...
                "--noEmit clean. THE SWEEP IS COMPLETE: all five cells "
                "(engineer/pm/process/connectors/copilot) conform on both "
                "daemon (registry + route gate + lifecycle) and app (Surface "
                "+ nav gate) sides, with every judgment call reasoned and "
                "recorded above. Nothing further is deferred within this "
                "item.",
