...
Outputs:
    ...
    app/assets/images/android-icon-foreground.png           (adaptive fg, H only)
    app/assets/images/android-icon-monochrome.png           (themed-icon H)
"""
import os
...
# --- brand palette (matches app/src/theme/tokens.ts dark theme) -------------
