# -*- coding: utf-8 -*-
"""Generate app/src/theme/tokens.ts - THE canonical palette source.
...
the same as tools/make_icon.py. Re-run after touching the palette:
py -3.12 tools/gen_tokens.py
"""
import math
import os
...
def main():
    ...
    ts = ("// AUTO-GENERATED by tools/gen_tokens.py (the canonical palette). Do not edit by hand.\n"
