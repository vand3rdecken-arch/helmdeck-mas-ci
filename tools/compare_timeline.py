# -*- coding: utf-8 -*-
"""Card 2 dual-write verifier (docs/multi-engine-build-plan.md).
...
Usage:
    py -3.12 tools/compare_timeline.py <card-id>
    py -3.12 tools/compare_timeline.py --last     # most recently active card
...
from daemon.spine.agent import claude_sessions, timeline_store  # noqa: E402
from daemon.cells.engineer import sessions  # noqa: E402
