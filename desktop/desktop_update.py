...
not invented:
  ...
  packages/app/src/desktop/updates/desktop-app-updater.ts
...
pm-silent-ota-expo-updates). deploy/push_update.sh publishes the web export
...
MANIFEST_NAME = "desktop.json"    # published by deploy/push_update.sh
