  ...
  function menu() {
    ...
    sheet.show({
      ...
      options: [
        ...
        { label: tr(k.fast_track ? "card.fastTrack.off" : "card.fastTrack.on")
  ...
  return (
    <View style={{ flex: 1, backgroundColor: t.canvas, paddingTop: insets.top }}>
      ...
      <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 12, paddingVertical: 8, gap: 8 }}>
        ...
        {k?.fast_track ? (
          <Pressable onPress={() => edit({ fast_track: false })} hitSlop={6} accessibilityLabel={tr("card.fastTrack.disable")}
