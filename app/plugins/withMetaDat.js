...
// plugin for `expo prebuild`/EAS, plus a bare-node CLI that deploy/build_apk.sh
// runs against the HAND-MANAGED app/android tree. One owner, both paths, no
// drift.
//
// WHY THIS FILE EXISTS AT ALL — the fact that changed, measured 2026-08-21.
// docs/glasses-reference.md §11.7 used to say the DAT artifacts were already in
...
//   - `mwdat-display`: the Ray-Ban DISPLAY lens is served by the glasses/
