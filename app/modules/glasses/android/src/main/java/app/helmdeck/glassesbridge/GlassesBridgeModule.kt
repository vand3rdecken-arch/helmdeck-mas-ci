 ...
 * compiled, present in the APK - and DEAD, because nothing in app/src could
 * start an Android Service. docs/glasses-reference.md §11.6 recorded that
 ...
 * tests/test_meta_dat_plugin.js, which asserts the manifest name and the Kotlin
 * class agree.
 *
