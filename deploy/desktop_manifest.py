...
Used by deploy/push_update.sh before publishing app/dist-desktop to the relay's
"desktop" channel dir, and by tests/test_desktop_update.py to build fixtures -
one source of truth for the manifest shape the desktop clients
(desktop/desktop_update.py, desktop/updater.js) consume:
...
a content change - yields a new id.
    ...
    py -3.12 deploy/desktop_manifest.py <export-dir> <version>
"""
import hashlib
import json
import os
