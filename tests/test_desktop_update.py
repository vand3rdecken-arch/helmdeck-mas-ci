...
# (deploy/desktop_manifest.py), served by the REAL relay (channel "desktop",
# existing /updates/assets route) on an ephemeral port, consumed by the REAL
# clients - desktop/desktop_update.py (tray side) end-to-end, and
# desktop/updater.js via node when node is available.
#   py -3.12 tests/test_desktop_update.py
import json
import os
import shutil
import socket
