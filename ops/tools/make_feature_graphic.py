# -*- coding: utf-8 -*-
"""Build the Play Store feature graphic (1024x500) - ops/docs/store/LISTING.md.
...
tokens (surfaces/app/src/theme/tokens.ts) rather than an approximation.

    py -3.12 ops/tools/make_feature_graphic.py

Output: ops/docs/store/feature-graphic.png
"""
import os
