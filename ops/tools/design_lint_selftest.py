...
Writes its own fixture under surfaces/app/src/ui/, lints it, deletes it - no repo
state is left behind either way (fixture dirs are created on demand and
removed again if this test created them). Run: python ops/tools/design_lint_selftest.py
...
p = "surfaces/app/src/ui/__lint_selftest__.tsx"
...
got = design_lint.lint(["surfaces/app/src/theme/tokens.ts"])
if got:
