...
Runs every self-sandboxed ops/tests/test_*.py sequentially - ONE home since the
...
Usage: py -3.12 ops/tools/run_suite.py       (from the repo root)"""
import glob
import os
import subprocess
import sys
...
for d in (os.path.join("ops", "tests"),):
