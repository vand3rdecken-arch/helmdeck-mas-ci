# -*- coding: utf-8 -*-
"""Self-sandboxing test for ops/tools/loop_state.py's _build_loop_enabled() - the
...
def main():
    real_live = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "daemon", "policy_live.json")
