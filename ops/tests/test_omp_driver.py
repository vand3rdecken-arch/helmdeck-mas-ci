# -*- coding: utf-8 -*-
"""The native OMP driver (ops/docs/multi-engine-build-plan.md Card 8).
...
_OmpSession built the same way ops/tests/test_p1_runtime.py's make_session does
...
# Measured live 2026-08-24 (ops/docs/multi-engine-build-plan.md Card 8): a single
