...
come up empty - a green-looking screenshot of nothing.
    ...
    cd surfaces/app && node node_modules/expo/bin/cli start --web --port 3607 --offline
    py -3.12 ops/tests/shot_modules_i18n.py <owner-token> [daemon-port] [web-port]
...
print("shots in ops/tests/_shots/")
