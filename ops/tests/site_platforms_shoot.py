...
Prereqs (local mode):  cd ops/deploy/waitlist && npx wrangler dev --port <port>
Run:  py -3.12 ops/tests/site_platforms_shoot.py [base-url] [tag]
      py -3.12 ops/tests/site_platforms_shoot.py http://127.0.0.1:3483 local
      py -3.12 ops/tests/site_platforms_shoot.py https://helmdeck.de live
"""
import os, sys
