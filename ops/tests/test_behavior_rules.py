...
# `pm` moved 2026-09-17 (henry-brief-thinning, owner ask "muss man das nicht
# duenner machen"): the WHOLE core was rewritten 28.5k -> 13.2k chars - incident
# history dropped (git holds it), duplicates of the on-demand index merged, the
