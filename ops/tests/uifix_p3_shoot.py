...
Prereqs:  py -3.12 ops/tests/uifix_p3_harness.py   (daemon + seeded c-p3 on :8199)
          node node_modules/expo/bin/cli export --platform web   (surfaces/app/dist)

    py -3.12 ops/tests/uifix_p3_shoot.py <device-token>

Serves surfaces/app/dist on a free port, injects direct-mode config (baseUrl + Bearer
