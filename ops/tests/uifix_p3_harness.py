...
STOP THIS BEFORE RUNNING ops/tools/run_gate.py (it listens on :8199)."""
...
records = [
    ...
    _rec(4, "assistant", [
        ...
        _tool("tu-ok", "Bash", {"command": "py -3.12 ops/tools/run_gate.py"}),
    ]),
    ...
    _rec(60, "assistant", [
        ...
        _tool("tu-cancel", "Edit", {"file_path": "surfaces/app/package.json",
