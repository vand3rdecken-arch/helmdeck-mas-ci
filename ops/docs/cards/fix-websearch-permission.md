...
> und der §6.3-Vorbehalt in `ops/docs/ios-watch-feasibility.md` per verifiziertem
...
"permissions": {
  "allow": [
    "Bash(bash ops/deploy/push_ntfy.sh*)",
    "Bash(bash ops/deploy/push_relay.sh*)",
    "Bash(bash ops/deploy/cloudflare_tunnel.sh*)",
    "WebSearch",
    "WebFetch"
  ]
}
...
2. Als Nachweis: der in `ops/docs/ios-watch-feasibility.md` §6.3 als „offen" markierte
...
- danach: `ops/docs/ios-watch-feasibility.md` §6 aktualisieren (Vorbehalt auflösen).
