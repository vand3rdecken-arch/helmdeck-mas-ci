...
The stack is **Electron + electron-builder** (confirmed: `surfaces/desktop/electron-builder.yml`, `surfaces/desktop/native-updater.js` wrapping `electron-updater`, `@electron/notarize` and `dmg-builder` in the lockfile).
